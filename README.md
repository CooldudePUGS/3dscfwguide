This a guide meant to describe how to use various functions of CFW (Custom FirmWare) features of the 3DS. You can get CFW by following the guide linked [here](https://3ds.hacks.guide)
